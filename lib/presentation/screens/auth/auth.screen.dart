      ...
      child: Column(
        ...
        children: [
          ...
          _buildTextField(
            ...
            validators: [
              (value) => value!.isEmpty ? 'Password is required' : null,
              (value) => !RegExp(r'^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$')
                      .hasMatch(value!)
                  ? 'Password must contain at least 8 characters, including letters and numbers'
                  : null,
            ],
          ...
          _buildTextField(
            ...
            validators: [
              ...
              (value) => value != controller.passwordController.text
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Text('I agree to all the terms and conditions'),
                    ],
                  ),
